...
__device__ void matmulRQK_3(const float *__restrict inputQ,
...
__device__ void matmulSV_3(float *sumQK, const float *__restrict inputV,
...
template <int Br, int Bc, int Rq, int Rv>
__global__ void attention_v3(const float *__restrict inputQ,
                                 ...
                                 float *__restrict output)
{
    ...
    for (int j = 0; j < Tc; j++)
    {
        ...
        matmulSV_3<Br, Bc, Rq, Rv>(sumQK, inputV, Vds, N, d, j, indQ, indK, indV,
