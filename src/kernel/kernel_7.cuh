...
__device__ void matmulRQK_7(const float *__restrict inputQ,
...
__device__ void matmulSV_7(float *shareQK, const float *__restrict inputV,
...
__global__ void attention_v7(const float *__restrict inputQ,
                                 ...
                                 float *__restrict output)
{
    ...
    for (int j = 0; j < Tc; j++)
    {
        ...
        matmulSV_7<Bk, Bc, Rq, Rv, numV>(shareQK, inputV, shareVK, N, d, j, indQ, indK, indV, val,
                 newMax, sumSV);
