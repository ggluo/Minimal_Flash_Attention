template <int Bd, int Bk, int Rq, int numQ, int numK>
__device__ void matmulRQK_6(const float *__restrict inputQ,
...
template <int Bk, int Bc, int Rq, int Rv, int numV>
__device__ void matmulSV_6(float *shareQK, const float *__restrict inputV,
...
template <int Br, int Bc, int Rq, int Rv, int Bd, int Bk, int numQ, int numK, int numV>
__global__ void attention_v6(const float *__restrict inputQ,
                                 ...
                                 float *__restrict output)
{
    ...
    for (int j = 0; j < Tc; j++)
    {
        ...
        matmulRQK_6<Bd, Bk, Rq, numQ, numK>(inputQ, inputK, shareQK, shareVK, N, d, width, indQ, indK,
                  val);
        ...
        matmulSV_6<Bk, Bc, Rq, Rv, numV>(shareQK, inputV, shareVK, N, d, j, indQ, indK, indV, val,
                 newMax, sumSV);
